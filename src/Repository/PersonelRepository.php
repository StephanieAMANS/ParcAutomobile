 ...
 */
class PersonelRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Personel $entity, bool $flush = false): void
    {
    ...
    public function remove(Personel $entity, bool $flush = false): void
    {
